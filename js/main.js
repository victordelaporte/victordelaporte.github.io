...
Table of Contents
  ...
  03  Flex Slider
  04  Google Map
  05  Coming Soon CountDown
  06  Accordions
  07  Preloader, Portfolio Filter, Mansonry Layout
  08  Video Background
  09  Photo Gallery
  10  Number Counter
  11  Scroll Height Setting
  12  Mailchimp Form
  13  General js code
...
(function($){
  ...
  function initMap() {
    ...
    var infowindow = new google.maps.InfoWindow({
      content: "Your Office Address Goes Here!"
    });
    ...
    var marker = new google.maps.Marker({
      ...
      title: 'Your Office Address Goes Here!'
    });
  ...
  function initAccordions () {
    ...
    /*
     07
     Preloader, Portfolio Filter, Mansonry Layout
    */
